...
from models import model as ml
...
def do_k_fold_evaluation(model, eye_X, head_X, target, fold=10):
    ...
    for train, test in kfold.split(eye_X, target):
        ...
        if hyper_parameters["classification"]:
            ...
            print("\n ### Evaluate (Test data_processor) on Fold : ", current_fold)
...
def train_model():
    ...
    # Eye Data
    print("Processing Eye Tracking data_processor")
    ...
    # Head Data
    print("Processing Head Tracking data_processor")
    ...
    head_input_layer, head_output_layer = model.conv_lstm(
        input_shape=(head_X.shape[1], head_X.shape[2], head_X.shape[3]))
